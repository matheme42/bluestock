...
class ToolsMenu extends StatelessWidget {
  ...
  const ToolsMenu({Key? key, required this.hawkFabMenuController})
      : super(key: key);
          ...
          return ValueListenableBuilder<bool>(
              ...
              builder: (context, value, child) {
                return ValueListenableBuilder(
                    valueListenable:
                        appContext.scannerController.cameraFacingState,
                    builder: (context, state, child) {
                      return HawkFabMenu(
                          blur: 0,
                          ...
                          items: [
                            HawkFabMenuItem(
                              label: 'Camera',
                              ontap: () =>
                                  appContext.scannerController.switchCamera(),
                            ...
                            HawkFabMenuItem(
                              ...
                              ontap: () =>
                                  appContext.scannerController.toggleTorch(),
                              icon: appContext
                                          .scannerController.torchState.value ==
                                      TorchState.off
                            ...
                            HawkFabMenuItem(
                              ...
                              ontap: () {
                                ...
                                SharedPreferenceController.setCameraFocus(val)
                                    .then((value) {
