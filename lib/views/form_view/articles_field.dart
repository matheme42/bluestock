      ...
      child: ValueListenableBuilder(
        ...
        builder: (context, value, _) {
          ...
          if (appContext.articleLoadedDate != null) {
            a.text = "Base articles du ${DateFormat.yMd().format(appContext.articleLoadedDate!)}";
          }
          return TextFormField(
            ...
            decoration: InputDecoration(
              ...
              counter: ValueListenableBuilder(
                ...
                builder: (context, value, _) {
                  return Text(
                    appContext.articleStrings.isEmpty ? "importer une liste d'articles" : 'metre a jour',
