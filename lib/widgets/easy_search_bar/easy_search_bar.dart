...
import 'package:bluestock/widgets/easy_search_bar/widgets/filterable_list.dart';
...
class EasySearchBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Can be used to set a textController manually
  final TextEditingController? textController;

  /// Can be used to check the focus on easySearchBar
  final FocusNode? focusNode;

  /// Can be used to check the focus on easySearchBar
  final Widget? leading;

  /// Can be used to check the state of the easySearchBar
  /// when the bar is close return false
  /// else return true
...
class EasySearchBarState extends State<EasySearchBar>
                  ...
                  child: Container(
                      ...
                      child: Scrollbar(
                        child: FilterableList(
                            ...
                            maxListHeight: MediaQuery.of(context).size.height -
                                size.height -
                                offset.dy -
                                50 -
