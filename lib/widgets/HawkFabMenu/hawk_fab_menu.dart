...
class HawkFabMenu extends StatefulWidget {
  ...
  @override
  HawkFabMenuState createState() => HawkFabMenuState();
}

class HawkFabMenuState extends State<HawkFabMenu>
  ...
  void initState() {
    ...
    if (widget.hawkFabMenuController != null) {
      ...
      widget.hawkFabMenuController!.isOpen = _isOpenF;
    }
  }

  bool _isOpenF() => _isOpen;
