...
class SharedPreferenceController {
  ...
  static Future<Locale> getLanguage() async {
    ...
    if (languageString != null) {
      language = Locale(
          languageString.substring(0, 2), languageString.substring(3, 5));
    }
  ...
  static Future<bool> getCFocus() async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    bool? cameraFocus = preferences.getBool(_cameraFocusKeys);
    return (cameraFocus ?? true);
  }

  static Future<void> setCameraFocus(bool value) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    preferences.setBool(_cameraFocusKeys, value);
  }
